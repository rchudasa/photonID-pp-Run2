...
####Start here
#####################################################################
OutputDirName = 'BinaryClassification_XGBoost_endcap' #All plots, models, config file will be stored here
branches=['scE',
          'scEt',
          'scEta',
          'scPhi',
...
processes = [
    ...
    'treeName':'mergedPi0_SCTree', 'selection':'(scEt>4) & (scEt<15) & abs(scEta)>1.566 & abs(scEta)<2.4', 'process':'Flat_pi0','category':1}, 
    {'Class':'Backg','fileName':'data_2018D_endcap.root',
    'treeName':'dataAllSCTree', 'selection':'(scEt>4) & (scEt<15) & abs(scEta)>1.566 & abs(scEta) < 2.4', 'process':'Data','category':1}     
]
