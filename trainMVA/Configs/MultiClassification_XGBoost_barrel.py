...
####Start here
#####################################################################
OutputDirName = 'MultiClassification_XGBoost_barrel' #All plots, models, config file will be stored here
branches=['scE',
          'scEt',
          'scEta',
          'scPhi',
...
processes = [
    ...
    'treeName':'mergedPi0_SCTree', 'selection':'(scEt>4) & (scEt<15) & abs(scEta)<1.4442', 'process':'Flat_pi0','category':2}, 
    {'Class':'Data','fileName':'data_2018D_barrel.root',
    'treeName':'dataAllSCTree', 'selection':'(scEt>4) & (scEt<15) & abs(scEta)<1.4442', 'process':'Data','category':3}     
]
