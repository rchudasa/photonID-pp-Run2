...
####Start here
#####################################################################
OutputDirName = 'BinaryClassification_XGBoost_barrel-v1' #All plots, models, config file will be stored here
branches=['scE',
          'scEt',
          'scEta',
          'scPhi',
...
processes = [
    ...
    'treeName':'genMatchedBMMGSCTree', 'selection':'(scEt>4) & (scEt<15) & abs(scEta)<1.4442 & (scFoundGsfMatch_ < 1)', 'process':'bsMMG', 'category':0, 'fraction' : 1},
    ...
    'treeName':'mergedPi0_SCTree', 'selection':'(scEt>4) & (scEt<15) & abs(scEta)<1.4442 & (scFoundGsfMatch_ < 1)', 'process':'Flat_pi0','category':1, 'fraction' : 1}, 
    {'Class':'Backg','fileName':'data_2018D_barrel.root',
    'treeName':'dataAllSCTree', 'selection':'(scEt>4) & (scEt<15) & abs(scEta)<1.4442 & (scFoundGsfMatch_ < 1)', 'process':'Data','category':1, 'fraction' : 0.1}     
]
