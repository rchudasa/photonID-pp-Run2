...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nPFCandidates;
   Float_t         pf_ecalEnergy[10000];   //[nPFCandidates]
   Float_t         pf_ecalRawEnergy[10000];   //[nPFCandidates]
   Float_t         pf_hcalEnergy[10000];   //[nPFCandidates]
   Float_t         pf_hcalRawEnergy[10000];   //[nPFCandidates]
   Float_t         pf_HoE[10000];   //[nPFCandidates]
   Float_t         pf_mvaIso[10000];   //[nPFCandidates]
   Float_t         pf_vertexX[10000];   //[nPFCandidates]
   Float_t         pf_vertexY[10000];   //[nPFCandidates]
   Float_t         pf_vertexZ[10000];   //[nPFCandidates]
   Float_t         pf_ecalEntryEta[10000];   //[nPFCandidates]
   Float_t         pf_ecalEntryPhi[10000];   //[nPFCandidates]
   Float_t         pf_ecalEntryX[10000];   //[nPFCandidates]
   Float_t         pf_ecalEntryY[10000];   //[nPFCandidates]
   Float_t         pf_ecalEntryZ[10000];   //[nPFCandidates]
   Float_t         pf_eta[10000];   //[nPFCandidates]
   Float_t         pf_phi[10000];   //[nPFCandidates]
   Float_t         pf_pt[10000];   //[nPFCandidates]
   Float_t         pf_id[10000];   //[nPFCandidates]
   Float_t         pf_mass[10000];   //[nPFCandidates]
